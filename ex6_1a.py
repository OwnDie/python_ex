...
elif not (ip_address_list[0].isdigit() and ip_address_list[1].isdigit() and ip_address_list[2].isdigit() and ip_address_list[3].isdigit()):
	print('Incorrect IPv4 address')
elif int(ip_address_list[0]) >= 1 and int(ip_address_list[0]) <=223:
	print('unicast')
